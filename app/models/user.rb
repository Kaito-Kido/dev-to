class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
    ...
    has_many :received_follows, foreign_key: :followed_id, class_name: Follow.name, dependent: :destroy
    has_many :followers, through: :received_follows, source: :follower
    has_many :given_follows, foreign_key: :follower_id, class_name: Follow.name, dependent: :destroy
